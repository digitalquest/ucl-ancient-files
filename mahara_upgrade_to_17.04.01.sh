# upgrade from mahara 16.04.05 to 17.04.01 - on PROD
# 1. backup
# 2. new code
# 3. upgrade.php
# 4. commit to repo 
...
cd $APP_ROOT
mkdir v${NEW_VERSION}
wget -c https://launchpad.net/mahara/17.04/17.04.1/+download/mahara-${NEW_VERSION}.tar.gz
